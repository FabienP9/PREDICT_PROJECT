...
def test_get_calculated_games_result():
    ...
    with patch.object(output_actions_calculated, 'snowflake_execute', return_value=mock_df_qgame):
        ...
        s_expected = read_txt("materials/output_actions_calculated_get_calculated_games_result.txt")
...
def test_get_calculated_scores_detailed():
    ...
    df_predict_games_expected = pd.read_csv("materials/output_actions_calculated_scores_details.csv", header=[0, 1],keep_default_na=False,na_filter=False)
...
def test_get_calculated_scores_global():
    ...
    df_expected = pd.read_csv("materials/output_actions_calculated_get_calculated_scores_global.csv")
...
def test_get_calculated_scores_gameday():
    ...
    df_expected = pd.read_csv("materials/output_actions_calculated_scores_gameday.csv")
...
def test_get_calculated_predictchamp_ranking():
    ...
    expected_result = pd.read_csv("materials/output_actions_calculated_predictchamp_rank.csv")
...
def test_get_calculated_parameters_df_management():
    ...
    param_dict = {
        "SCORES_DETAILED_DF": pd.read_csv("materials/output_actions_calculated_scores_details.csv", header=[0, 1],keep_default_na=False,na_filter=False),
        "SCORES_GLOBAL_DF": pd.read_csv("materials/output_actions_calculated_get_calculated_scores_global.csv"),
        "SCORES_GAMEDAY_DF": pd.read_csv("materials/output_actions_calculated_scores_gameday.csv"),
        "RANK_PREDICTCHAMP_DF": pd.read_csv("materials/output_actions_calculated_predictchamp_rank.csv"),
        "IS_FOR_RANK": 1,
    }
    with patch("output_actions_calculated.outputA.manage_df", side_effect=["url1", "url2", "url3","url4"]) as mock_manage_df:
         
        result = output_actions_calculated.get_calculated_parameters_df_management(param_dict,sr_gameday_output_calculate,country,forum)
