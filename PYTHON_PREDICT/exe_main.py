...
from output_need_actions import generate_output_need
from output_need_actions import set_output_need_to_check_status
from game_actions.game_actions import extract_games_from_need
from message_actions.message_actions import extract_messages
import snowflake_actions as snowflakeA
from output_message_generation_actions import output_message_actions as outputA
...
def process_games(context_dict: dict) -> dict:
    ...
    context_dict['df_game'] = extract_games_from_need(context_dict['sr_output_need'],context_dict['df_competition'])
...
def exe_main():
    ...
    config.check_environment_variable(called_by)
    context_dict = {}
