...
- To prepare a new competition
    ...
    - add URL of the source in GitHub secret to call it in the software [ -> See section Input parameters](#inputparameters )and add the variable in the function *config.py/check_environment_variable*
...
- To link the competition with new topics
    ...
    - add URL of the forum in GitHub secret to call it in the software [ -> See section Input parameters](#inputparameters) and add the variable in the function *config.py/check_environment_variable*
