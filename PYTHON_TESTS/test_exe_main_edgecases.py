...
def test_process_games_gameA_failure():
    ...
    with patch.object(exe_main,"extract_games_from_need", side_effect=RuntimeError("boom")), \
...
def test_process_messages_extract_messages_failure():
    ...
    with patch.object(exe_main,"extract_messages", side_effect=ValueError("bad")):
...
def test_exe_main_dropbox_failure():
    ...
    with patch.object(exe_main.config,"check_environment_variable"),\
         patch.object(exe_main,"dropbox_initiate_folder", side_effect=OSError("dropbox fail")):
...
def test_exe_main_generate_output_need_failure():
    ...
    with patch.object(exe_main.config,"check_environment_variable"),\
         ...
         patch.object(exe_main,"generate_output_need", side_effect=Exception("gen fail")):
