...
odds as (
    SELECT
        ...
        CAST(COALESCE(NB_PREDICTOR_WINNER_HOME*100/ NULLIF(NB_PREDICTOR_WINNER_HOME + NB_PREDICTOR_WINNER_AWAY,0),50) AS INT) AS PERC_PREDICTOR_WINNER_HOME,
        CAST(COALESCE(NB_PREDICTOR_WINNER_AWAY*100/ NULLIF(NB_PREDICTOR_WINNER_HOME + NB_PREDICTOR_WINNER_AWAY,0),50) AS INT) AS PERC_PREDICTOR_WINNER_AWAY,
    FROM
...
SELECT
    ...
    COALESCE(odds.NB_PREDICTOR_WINNER_HOME,0) AS NB_PREDICTOR_WINNER_HOME,
    COALESCE(odds.NB_PREDICTOR_WINNER_AWAY,0) AS NB_PREDICTOR_WINNER_AWAY,
    COALESCE(odds.PERC_PREDICTOR_WINNER_HOME,50) AS PERC_PREDICTOR_WINNER_HOME,
    COALESCE(odds.PERC_PREDICTOR_WINNER_AWAY,50) AS PERC_PREDICTOR_WINNER_AWAY,
    15 + CAST(CASE
