...
def test_process_games():
    ...
    with patch.object(exe_main,"extract_games_from_need",return_value=mock_df_game), \
         patch.object(exe_main.fileA,"filter_data"):
...
def test_process_messages_autoprocess():
    ...
    with patch.object(exe_main,"extract_messages",return_value=(df_message_check,extraction_time_utc)), \
         patch.object(exe_main.fileA,"filter_data", return_value={}), \
         patch.object(exe_main,"set_output_need_to_check_status"), \
         patch.object(exe_main.fileA,"create_csv"), \
         patch.object(exe_main.fileA,"create_csv"):
...
def test_exe_main():
    ...
    with patch.object(exe_main.config,"check_environment_variable"),\
         patch.object(exe_main,"dropbox_initiate_folder"), \
         patch.object(exe_main.fileA,"initiate_local_environment", return_value=mock_initiate_local_dict), \
         patch.object(exe_main,"generate_output_need", return_value=mock_sr_output_need), \
         patch.object(exe_main.fileA,"download_needed_files",return_value = {}),\
         patch.object(exe_main,"process_games",return_value = mock_initiate_local_dict), \
         patch.object(exe_main,"process_messages",return_value = mock_initiate_local_dict), \
         patch.object(exe_main.snowflakeA,"delete_tables_data_from_python"), \
         patch.object(exe_main.snowflakeA,"update_snowflake"), \
         patch.object(exe_main,"update_calendar_related_files",return_value = mock_extraction_time_utc), \
         patch.object(exe_main.outputA,"generate_output_message"), \
         patch.object(exe_main.fileA,"terminate_local_environment"), \
