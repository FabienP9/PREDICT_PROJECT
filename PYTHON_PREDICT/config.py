...
def exit_program(log_filter=None, execute_final_function: Literal[0, 1] = 1):
    '''
        ...
        Args:
            ...
            execute_final_function (0/1): If 1 (defaullt), will call the function onError_final_execute
    '''
    def decorator(func):
...
@exit_program(log_filter=lambda args: dict(args), execute_final_function = 0)
def check_environment_variable(called_by: str):
    ...
    ENV_VARS = [
        {"var": "IS_TESTRUN", "bool": 1,  "main": 1,  "snowflake": 1, "compet": 1},
        {"var": "IS_OUTPUT_AUTO", "bool": 1,  "main": 1,  "snowflake": 0, "compet": 0},
        {"var": "OVERWRITE_GAMES_STATUS", "bool": 1,  "main": 1,  "snowflake": 0, "compet": 0},
        {"var": "BI_URL", "bool": 0, "main": 1, "snowflake": 0, "compet": 0},
        {"var": "BI_USERNAME", "bool": 0, "main": 1, "snowflake": 0, "compet": 0},
        {"var": "BI_PASSWORD", "bool": 0, "main": 1, "snowflake": 0, "compet": 0},
        {"var": "SNOWFLAKE_USERNAME", "bool": 0, "main": 1, "snowflake": 1, "compet": 1},
        {"var": "SNOWFLAKE_PASSWORD", "bool": 0, "main": 1, "snowflake": 1, "compet": 1},
        {"var": "LNB_URL", "bool": 0, "main": 1, "snowflake": 0, "compet": 1},
        {"var": "IMGBB_API_KEY", "bool": 0, "main": 1, "snowflake": 0, "compet": 0},
    ]
    ...
    for env in ENV_VARS:
        ...
        if env["bool"] == 1 and int(value) not in (0,1):
