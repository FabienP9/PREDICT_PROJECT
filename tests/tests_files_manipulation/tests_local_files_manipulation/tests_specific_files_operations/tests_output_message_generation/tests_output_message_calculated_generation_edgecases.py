...
def test_get_games_result_empty_df(read_csv):
...
def test_get_games_result_negative_result(read_csv,read_txt):
...
def test_get_scores_detailed_missing_split(read_csv,assert_exit):
    ...
    with patch.object(output_message_calculated_generation, "snowflake_execute", return_value=mock_df_predict_games):
        assert_exit(lambda: output_message_calculated_generation.get_scores_detailed(sr_snowflake_account, sr_gameday_output_calculate))
...
def test_get_scores_gameday_empty(read_csv):
...
def test_get_scores_gameday_missing_column(read_csv, assert_exit):
    ...
    with patch.object(output_message_calculated_generation, "snowflake_execute", return_value=mock_df_userscores_gameday), \
        patch.object(output_message_calculated_generation.output, "display_rank", return_value=mock_df_userscores_gameday_ranked):
            assert_exit(lambda: output_message_calculated_generation.get_scores_gameday(sr_snowflake_account, sr_gameday_output_calculate))
...
def test_get_predictchamp_ranking_empty(read_csv):
...
def test_get_correction_no_rows(read_csv):
...
def test_get_mvp_month_race_figure_empty_df(read_csv):
...
def test_get_mvp_month_race_figure_invalid_points(read_csv,read_txt, assert_exit):
...
def test_list_mvp_month_race_gameday_empty(read_csv,read_txt, assert_exit):
...
def test_get_mvp_compet_race_figure_missing_key(read_csv,read_txt, assert_exit):
    ...
    with patch.object(output_message_calculated_generation, "snowflake_execute", return_value=mock_df_compet_mvp):
        assert_exit(lambda: output_message_calculated_generation.get_mvp_compet_race_figure(sr_snowflake_account, sr_gameday_output_calculate))

def test_list_mvp_compet_race_gameday_missing_columns(read_csv,read_txt, assert_exit):
    ...
    with patch.object(output_message_calculated_generation, "snowflake_execute", return_value=mock_df_list_gameday):
        assert_exit(lambda: output_message_calculated_generation.list_mvp_compet_race_gameday(sr_snowflake_account,sr_gameday_output_calculate))

def test_list_mvp_compet_race_gameday_badtypes(read_csv,read_txt, assert_exit):
...
def test_get_parameters_no_predictchamp(read_csv,read_txt, assert_exit):
...
def test_get_parameters_missing_key(read_csv,read_txt, assert_exit):
    ...
    with patch.object(output_message_calculated_generation,"get_games_result", return_value=(mock_str_games_result, 2)), \
        ...
        assert_exit(lambda: output_message_calculated_generation.get_parameters(sr_snowflake_account, sr_gameday_output_calculate))
...
def test_process_output_message_no_topics(read_csv,read_txt, read_json):
...
def test_process_output_message_posting_fails(read_csv,read_txt, assert_exit,read_json):
